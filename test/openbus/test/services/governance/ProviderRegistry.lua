  ...
  ProviderFixture{
    Suite{
      ...
      ConsistencyChangesProvider = function(fixture)
        ...
        provider:_set_supportoffice("Tecgraf/Engdist/OpenBus")
        provider:_set_manageroffice("Tecgraf/External")
        ...
        checks.assert(updated:_get_supportoffice(), checks.is(provider:_get_supportoffice()))
        checks.assert(updated:_get_manageroffice(), checks.is(provider:_get_manageroffice()))
