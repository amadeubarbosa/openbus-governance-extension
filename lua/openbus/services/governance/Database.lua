...
local actions = {
  ...
  { name="addContract",
    values = { "name" } },
  { name="addProvider",
    values = { "name", "code", "supportoffice", "manageroffice", "support", "manager", "busquery" } },
  { name="addConsumer",
    values = { "name", "code", "supportoffice", "manageroffice", "support", "manager", "busquery" } },
  { name="addIntegration",
  ...
  { name="setProviderCode",
    ...
    set="code",
    where="name" },
  { name="setProviderSupportOffice",
    table="provider",
    set="supportoffice",
    where="name" },
  { name="setProviderManagerOffice",
    table="provider",
    set="manageroffice",
    where="name" },
  ...
  { name="setConsumerCode",
    ...
    set="code",
    where="name" },
  { name="setConsumerSupportOffice",
    table="consumer",
    set="supportoffice",
    where="name" },
  { name="setConsumerManagerOffice",
    table="consumer",
    set="manageroffice",
    where="name" },
